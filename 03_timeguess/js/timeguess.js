...
let soundEndFlag = "0"; // 背景サウンドフラグ
let startSound = "sound/start.mp3";
let stop1Sound = "sound/stop1.mp3";
let stop2Sound = "sound/stop2.mp3";
let resetSound = "sound/reset.mp3";
...
stop.addEventListener("click",
  function () {
    ...
    if (parseInt(stopTime) >= 10000 && parseInt(stopTime) < 11000) {
      body.style.background = "url(img/fireworks.gif) center center / cover";
      w_sound = stop2Sound;
    } else {
      w_sound = stop1Sound;
    }
