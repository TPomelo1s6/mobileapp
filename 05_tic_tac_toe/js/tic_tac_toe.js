...
// メッセージ
const msgtxt1 = '<p class="image"><img src="./img/cat.png" width="61px" height="61px"></p><p class="text">Cat Attack!</p>';
const msgtxt2 = '<p class="image"><img src="./img/panda.png" width="61px" height="61px"></p><p class="text">Panda Attack!</p>';
